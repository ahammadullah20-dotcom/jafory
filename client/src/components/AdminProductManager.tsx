...
export default function AdminProductManager() {
  ...
  const save = trpc.admin.products.save.useMutation({ onSuccess: () => { setSaveMessage("Product saved successfully."); toast.success("Product saved successfully."); utils.admin.products.list.invalidate(); utils.admin.overview.invalidate(); }, onError: error => { setSaveMessage(error.message || "Product could not be saved."); toast.error(error.message || "Product could not be saved."); } });
